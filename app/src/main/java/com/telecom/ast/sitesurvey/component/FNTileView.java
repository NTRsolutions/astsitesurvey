...
public class FNTileView extends LinearLayout {
	...
	protected FNTextView titleView, countView, explanationView;
	...
	public FNTileView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public FNTileView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.FNTileView, defStyle, 0);
		if (array.hasValue(R.styleable.FNTileView_imgHeight)) {
			this.imgHeight = (int) array.getDimension(R.styleable.FNTileView_imgHeight, ASTUIUtil.getDimension(R.dimen._30dp));
		}
		if (array.hasValue(R.styleable.FNTileView_imgWidth)) {
			this.imgWidth = (int) array.getDimension(R.styleable.FNTileView_imgWidth, ASTUIUtil.getDimension(R.dimen._30dp));
		}
		if (array.hasValue(R.styleable.FNTileView_outerPadding)) {
			this.outerPadding = (int) array.getDimension(R.styleable.FNTileView_outerPadding, ASTUIUtil.getDimension(R.dimen._12dp));
		}
		if (array.hasValue(R.styleable.FNTileView_isCircularImg)) {
			this.isCircularImg = array.getBoolean(R.styleable.FNTileView_isCircularImg, false);
		}
		array.recycle();
		this.init();
	}
	...
	public void setTitle(String title) {
		FNTextView titleView = getTileView();
		if (titleView == null) {
			return;
		}
