...
import com.telecom.ast.sitesurvey.component.FNFontViewField;
import com.telecom.ast.sitesurvey.component.FNTextView;
import com.telecom.ast.sitesurvey.constants.Contants;
import com.telecom.ast.sitesurvey.filepicker.FNFilePicker;
import com.telecom.ast.sitesurvey.listener.AlertDialogBoxClickInterface;
...
import static com.telecom.ast.sitesurvey.utils.ASTUtil.appNameWithoutSpace;
...
public class ASTUIUtil {
    ...
    public static void showErrorIndicator(Context context, String errorMsg, View belowOf) {
        if (ApplicationHelper.application().getActivity() != null && ApplicationHelper.application().getActivity().findViewById(R.id.errorIndicatorView) != null) {
            ...
            FNTextView errorMsgView = ApplicationHelper.application().getActivity().findViewById(R.id.error_msg);
            FNFontViewField closeButton = ApplicationHelper.application().getActivity().findViewById(R.id.closeErrorIndicator);
