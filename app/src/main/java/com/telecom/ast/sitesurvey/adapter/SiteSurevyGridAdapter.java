...
public class SiteSurevyGridAdapter extends BaseAdapter {
    ...
    private void getUserPref() {
        userPref = context.getSharedPreferences("SharedPref", MODE_PRIVATE);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == 0) {
        ...
        } else if (strSiteId != null && CurtomerSite_Id != null && !strSiteId.equals("") && !strSiteId.equals("0") && !CurtomerSite_Id.equals("") && !CurtomerSite_Id.equals("0")) {
            if (position == 1) {
                ...
                llGridItem.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        //BatteryHomeFragment batteryFragment = new BatteryHomeFragment();
            ...
            ASTUIUtil.showToast("Please fill first Basic data.");
        }
        return gridView;
    }
