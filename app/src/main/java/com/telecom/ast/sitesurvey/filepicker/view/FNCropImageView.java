...
import com.telecom.ast.sitesurvey.filepicker.animation.SimpleValueAnimator;
import com.telecom.ast.sitesurvey.filepicker.animation.SimpleValueAnimatorListener;
import com.telecom.ast.sitesurvey.filepicker.animation.ValueAnimatorV14;
import com.telecom.ast.sitesurvey.filepicker.animation.ValueAnimatorV8;
...
public class FNCropImageView extends AppCompatImageView {
    ...
    public Bitmap getCircularBitmap(Bitmap square) {
        ...
        setTimeStampIntoImage(canvas, paint, halfHeight / 3);
        return output;
    }
