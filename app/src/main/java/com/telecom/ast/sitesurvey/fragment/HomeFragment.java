...
public class HomeFragment extends MainFragment {
    ...
    public void parseandsaveCircleMasterData(String result) {
        if (result != null) {
            try {
                ...
                if (jsonStatus.equals("1")) {
                    ...
                    ASTUIUtil.showToast("No Master Data Found");
                }
    ...
    public void parseandsaveSiteMasterData(String result) {
        if (result != null) {
            try {
                atmDatabase = new AtmDatabase(getContext());
                ...
                if (jsonStatus.equals("1")) {
                    ...
                    ASTUIUtil.showToast("No Data Found");
                }
    ...
    public void parseandsaveEquipmentListMaster(String result) {
        if (result != null) {
            try {
                atmDatabase = new AtmDatabase(getContext());
